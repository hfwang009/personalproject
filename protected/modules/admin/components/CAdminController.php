...
//            var_dump($controller.'/'.$action!='adminsettingpanel/error'&&$controller.'/'.$action!=$controller.'/setting');exit;
            if(!isset($privilieges[0])&&!(isset($privilieges[$controller])&&in_array($action,$privilieges[$controller]))&&($controller.'/'.$action!='adminsettingpanel/error'&&$controller.'/'.$action!=$controller.'/setting'&&$controller.'/'.$action!=$controller.'/updatepass')){
