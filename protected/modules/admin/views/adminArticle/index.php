        ...
        <div class="mod-head">
            <h3>
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#list" data-toggle="tab">文章列表</a>
                    </li>
                    <li>
                        <a href="<?php echo Yii::app()->createUrl(Yii::app()->controller->module->id.'/'.Yii::app()->controller->id . '/add');?>">添加文章</a>
                    </li>
                    <li>
                        ...
                        <table class="table table-striped">
                            ...
                            if(!empty($model)){
                                ...
                                foreach ($model as $_model){
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="<?php echo $_model['id'];?>" name="article_id[]">
                                        </td>
