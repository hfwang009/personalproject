        ...
        <div class="mod-head">
            <h3>
                <ul class="nav nav-tabs">
                    <li>
                        <a href="<?php echo Yii::app()->createUrl(Yii::app()->controller->module->id.'/'.Yii::app()->controller->id . '/index');?>">品牌列表</a>
                    </li>
                    <li class="active">
                        <a data-toggle="tab" href="#add">添加品牌</a>
                    </li>
                    <li>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr><?php echo !empty($model['id'])?$model['id']:''; ?>
                            <td>
                                <?php echo CHtml::submitButton(!empty($model['id'])?'编辑品牌':'添加品牌',array('class'=>'btn btn-primary center-block'))?>
                            </td>
                        </tr>
                        </tfoot>
                    </table>
