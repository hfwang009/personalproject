...
<div class="banner003">
    <div class="container">
        ...
        质保查询 ><a href="#shenqing" style="margin-left: 20px;color:#737373;">质保申请</a><a href="#cx" style="margin-left: 20px;color:#737373;">质保查询</a>
    </div>
</div>
<div style="background-color: #131629">
    <div class="container" style="background-color: #fff">
        <img src="<?php echo Yii::app()->request->baseUrl ?>/statics/webfront/images/zhibao112.jpg" width="100%" height="auto" />


        <div class="col-md-8" style="margin-left:17%" id="shenqing">
            <div class="sidebar">
                <div class="vbf">
                    ...
                    $form = $this->beginWidget("CActiveForm",array(
                            'id'=>'warranty_form',
                            'method'=>'POST',
                            'action'=>Yii::app()->createUrl(Yii::app()->controller->id . '/add'),
                    ...
                    <div class="form-group">
                        <div class="form_select" style="position: relative;">
                            <input type="text" name="Warranty[authcode]" id="Warranty_authcode" class="form-control" style="width:85%;float:left;" placeholder="请输入验证码">
                                    <span style="float: right;margin-top: 5px;">
                                        <button type="button" class="btn btn-primary" id="sendauthcode">获取验证码</button>
                                    </span>
                        </div>
                    </div>
                    <button class="button btn_lg btn_blue btn_full" type="button" id="add_submit">点击提交质保申请</button>
                    <?php $this->endWidget(); ?>
                    <br>
                    <br>
                    <br>
...
<div style="background-color: #131629">
    <div class="container" style="background-color: #fff" id="cx">
        <img src="<?php echo Yii::app()->request->baseUrl ?>/statics/webfront/images/zhibao003.jpg" width="100%" height="auto" />


        <div class="col-md-8" style="margin-left:17%">
            <div class="sidebar">
                <div class="vbf" style="margin-bottom: 50px;">
                    <?php
                    $form = $this->beginWidget("CActiveForm",array(
                            'id'=>'warranty_form',
                            'method'=>'POST',
                            'action'=>Yii::app()->createUrl(Yii::app()->controller->id . '/search'),
                            'enableClientValidation'=>false,
                            'clientOptions'=>array(
                                'validateOnSubmit'=>true,
                            ),
                    ...
                    <div class="form-group">
                        <div class="form_select">
                            <?php echo $form->textField($model,'carlicence',array('placeholder'=>'请输入手机号/车架号（后六位）/质保证书编号/', 'class'=>'form-control'));?>
                        </div>
                    </div>
                    <button class="button btn_lg btn_blue btn_full" type="submit">点击查询质保</button>
                    <?php $this->endWidget(); ?>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var url = '<?php echo Yii::app()->createUrl(Yii::app()->controller->id.'/setting'); ?>';
    $(function(){
